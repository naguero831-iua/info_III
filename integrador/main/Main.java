...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("5. Ejercicio 5 - Planner (programar recordatorios, min-heap)");
            System.out.println("6. Ejercicio 6 - Consultar indice pacientes (hash chaining propio)");
            System.out.println("7. Ejercicio 7 - Consolidador de agendas (Merge/dedup demo)");
            System.out.println("8. Ejercicio 8 - Reportes de Ordenamientos (Shell, Quick)");
